...
export default function LadoIzquiero() {
  return (
    <section className="h-full left-side w-full pt-10 xl:pr-56 p-6 xl:p-24 lg:w-1/2 flex items-center justify-center bg-gray-950">
      <div className="flex flex-col gap-7">
        ...
        <p className="text-sm/tight font-semibold leading-[1.4rem] text-center   text-gray-300 lg:text-justify">
