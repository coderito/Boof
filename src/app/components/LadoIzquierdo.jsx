    ...
    <section className="h-screen left-side w-full xl:pr-56 p-6 xl:p-24 lg:w-1/2 flex items-center justify-center bg-gray-950">
      <div className="flex flex-col gap-7">
        <h1 className="font-display text-4xl  md:text-5xl leading-[2.5rem] lg:leading-[3rem] font-bold text-white">
          ...
          <span className="text-yellow-300 cursor-pointer hover:text-yellow-400">
            1 time in your life
          </span>
        </h1>

        <p className="text-sm/tight leading-[1.4rem] text-gray-300 lg:text-justify">
          Discover the 10 essential books 📗 to boost your personal growth,
          Immerse yourself in the fascinating world of reading and discover the
          books that will transform your life! On our website, we offer you a
          careful selection of the best{" "}
          <span className="text-yellow-300 font-semibold">10 books </span>that
